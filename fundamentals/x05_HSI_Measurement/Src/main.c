...
int main(void)
{
	...
	//* 1. Enable the peripheral clock for ADC1 Bit 13 ADCEN: ADC clock enable
	*pRccAhb2Reg |= (1 << 13);

	//* 2. Modify the ADC CR1 register set Bit 0 to enable ADC
...
//* This function is a Interrupt event handler which address is defined in the startup file using the Vector Table
